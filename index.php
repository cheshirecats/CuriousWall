...
<div id="mid_container">
  <div id="mid" class="box wall">
    ...
    <?php /* locking switch */ if ((isset($_SESSION['permissions']) && ($_SESSION['permissions'] == 1))) { echo '<div id="stickingswitch" class="radioswitch"><input type="radio" id="nolock" class="inputlocked" name="lock" value="nolock"><label for="nolock">Unlock</label><div id="lockingswitch" class="radioswitch"><input type="radio" id="ylock" class="inputlocked" name="lock" value="ylock"><label for="ylock">Lock</label></div>';}else {} /**/?>
